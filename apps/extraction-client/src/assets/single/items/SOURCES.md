...
|---|---|---|
| `iron_pickaxe.png` | `iron_pickaxe` (16×16) | 槽 2 / 第一人称镐 |
| `stone_pickaxe.png` | `stone_pickaxe` | 备用 |
| `wood_pickaxe.png` | `wood_pickaxe` | 备用 |
| `iron_sword.png` | `iron_sword` (16×16) | 槽 3 / 第一人称剑 |
...
Runtime: `LocalViewmodel` in `apps/extraction-client/src/single/viewmodel.ts`.
